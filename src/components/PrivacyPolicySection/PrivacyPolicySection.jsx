...
import AboutUsImage from "../../assets/images/privacy-bg.jpeg";
...
export const PrivacyPolicySection = () => {
  ...
  return (
    <section className="privacy-policy-section" id="about">
      <div className="privacy-policy-section__container">
        <h1>Privacy Policy</h1>
        <div className="privacy-policy-section__canvas">
        ...
        <article>
          ...
          <ul>
            ...
            <li>
              <p>
                <strong>Application</strong> refers to Revenant's Souls, the
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to teamoceangames.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to teamoceangames, accessible
                from{" "}
                <a
                  href="https://teamoceangames.com/"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  https://teamoceangames.com/
                </a>
              </p>
            </li>
            <li>
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                <a
                  href="https://teamoceangames.com/#contact"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  https://teamoceangames.com/#contact
                </a>
              </p>
            </li>
          </ul>
